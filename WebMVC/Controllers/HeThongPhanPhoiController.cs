...
namespace WebMVC.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHTPP,TenHeThong,DiaChi,DienThoai,Email")] HeThongPhanPhoi heThongPhanPhoi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaHTPP,TenHeThong,DiaChi,DienThoai,Email")] HeThongPhanPhoi heThongPhanPhoi)
        {
